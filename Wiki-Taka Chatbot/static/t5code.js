...
function setup() {
  ...
  pop.volume = 0.2;
  rs = new RiveScript();
  rs.loadFile(["/static/t5chatbotRiveScript.html"], on_load_success, on_load_error);
}
  ...
  setTimeout(function() {
    $("#dialogue").append(
      "<div class='bot-row' id='" +
        waitid +
        "'><img class= 'chatbotprofile' src = '/img/Wikidqprofile.png' alt = 'noproflies'><span class='bot'>" +
        reply +
        "</span></div>"
    );
    pop.play();
